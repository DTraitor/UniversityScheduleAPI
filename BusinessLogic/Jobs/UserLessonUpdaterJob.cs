...
public class UserLessonUpdaterJob<T, TModifiedEntry> : IHostedService, IDisposable where TModifiedEntry : IModifiedEntry
{
    private IServiceProvider _services;
    private readonly ILogger<UserLessonUpdaterJob<T, TModifiedEntry>> _logger;
    ...
    public UserLessonUpdaterJob(
        ...
        ILogger<UserLessonUpdaterJob<T, TModifiedEntry>> logger)
    {
        _services = services;
        _logger = logger;
    }
